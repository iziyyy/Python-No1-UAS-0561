...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jan 2022 pada 15.11
...
--
-- Struktur dari tabel `tbl_students_0561`
--

CREATE TABLE `tbl_students_0561` (
  `id` int(100) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0561`
--

INSERT INTO `tbl_students_0561` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indeks untuk tabel `tbl_students_0561`
--
ALTER TABLE `tbl_students_0561`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_students_0561`
--
ALTER TABLE `tbl_students_0561`
